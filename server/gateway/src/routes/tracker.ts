...
module.exports = (router:any) => {  
    router.all("/tracker/:api_path?", VALIDATE_SESSION, (req: Request, res: Response) => {
        ...
        .then(() => {
            ...
            let path:string = LOAD_BALANCE("tracker", "golang", i)+params.replace("/?", "?");
            let session_key:string = user.user_id+"-"+LOAD_BALANCE("tracker", "golang", i)+api_path; // generate request session key 
